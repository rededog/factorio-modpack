...
if data.raw.item["titanium-bearing"] then
  ...
  bobmods.lib.recipe.add_ingredient("green-underground-belt", {"titanium-bearing", 40})
...
if data.raw.recipe["purple-underground-belt"] then
  if data.raw.item["nitinol-bearing"] then
    bobmods.lib.recipe.add_ingredient("purple-underground-belt", {"nitinol-bearing", 60})
  else
    bobmods.lib.recipe.add_ingredient("purple-underground-belt", {"iron-gear-wheel", 40})
  end
