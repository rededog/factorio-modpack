...
local pump_circuit_wire_connection_points = {
      {
        shadow =
        {
...
{
  {
    ...
    minable = {mining_time = 1, result = "bob-pump-2"},
    max_health = 220,
    ...
    circuit_wire_connection_points = pump_circuit_wire_connection_points,
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/pump.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 1, result = "bob-pump-3"},
    max_health = 260,
    fast_replaceable_group = "pipe",
    corpse = "small-remnants",
    collision_box = {{-0.29, -0.79}, {0.29, 0.79}},
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/pump.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 1, result = "bob-pump-4"},
    max_health = 300,
    fast_replaceable_group = "pipe",
    corpse = "small-remnants",
    collision_box = {{-0.29, -0.79}, {0.29, 0.79}},
