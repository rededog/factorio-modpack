...
function bobmods.power.heat_exchanger_structure()
return {
      north =
      {
        layers =
...
{
  {
    ...
    structure = bobmods.power.heat_exchanger_structure(),
    fire = {},
    fire_glow = {},
    burning_cooldown = 20
  },
  {
    ...
    icon = "__base__/graphics/icons/heat-boiler.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "heat-exchanger-3"},
    max_health = 300,
    corpse = "small-remnants",
    vehicle_impact_sound =  { filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65 },
    mode = "output-to-separate-pipe",
