if bobmods.plates then
	...
	angelsmods.functions.OV.set_output("slag-processing-7", "fluorite-ore", "item", {amount=1, probability=0.05})
	...
	data.raw["item"]["angels-ore3-crystal"].localised_description = {"item-description.angels-ore3-crystal", {"item-description.loc-copper"}, {"item-description.loc-dot"}, {"item-description.loc-iron"}, {"item-description.loc-dot"}, {"item-description.loc-cobalt"}, {"item-description.loc-dot"}, {"item-description.loc-tin"}, {"item-description.loc-dot"}, {"item-description.loc-uranium"}, {"item-description.loc-and"}, {"item-description.loc-slag"}, "", "",}
	data.raw["item"]["angels-ore3-pure"].localised_description = {"item-description.angels-ore3-pure", {"item-description.loc-copper"}, {"item-description.loc-dot"}, {"item-description.loc-iron"}, {"item-description.loc-dot"}, {"item-description.loc-cobalt"}, {"item-description.loc-dot"}, {"item-description.loc-tin"}, {"item-description.loc-dot"}, {"item-description.loc-uranium"}, {"item-description.loc-and"}, {"item-description.loc-bauxite"}, "", "",}
	--CROTINIUM (COPPER, IRON, LEAD, SILVER, GOLD, RUTILE)
	...
	data.raw["item"]["angels-ore6-pure"].localised_description = {"item-description.angels-ore6-pure", {"item-description.loc-tin"}, {"item-description.loc-dot"}, {"item-description.loc-quartz"}, {"item-description.loc-dot"}, {"item-description.loc-cobalt"}, {"item-description.loc-dot"}, {"item-description.loc-zinc"}, {"item-description.loc-dot"}, {"item-description.loc-bauxite"}, {"item-description.loc-and"}, {"item-description.loc-uranium"}}
