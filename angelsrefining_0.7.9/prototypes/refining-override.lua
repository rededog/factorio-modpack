--MODIFICATION TO REFINING
	...
	angelsmods.functions.OV.remove_output("angelsore-crystal-mix5-processing", "angels-void")
...
if not angelsmods.petrochem then
	...
	angelsmods.functions.OV.set_output("angelsore2-chunk", "water-greenyellow-waste", "fluid", 50)	
	angelsmods.functions.OV.remove_output("angelsore4-chunk", "water-yellow-waste")	
	angelsmods.functions.OV.set_output("angelsore4-chunk", "water-green-waste", "fluid", 50)	
	angelsmods.functions.OV.remove_output("angelsore5-chunk", "water-yellow-waste")	
	angelsmods.functions.OV.set_output("angelsore5-chunk", "water-red-waste", "fluid", 50)	
