...
--CHUNK (6/6)
{ name = "angelsore2-chunk-processing", results = {{"!!"}, { name = "iron-ore", type = "item", amount = 5}, { name = "angels-iron-nugget", type = "item", amount = 2}, { name = "angels-iron-pebbles", type = "item", amount = 2}}},
--CRYSTAL (8/8)
