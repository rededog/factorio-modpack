...
bobmods.lib.tech.add_recipe_unlock("combat-robotics", "defender-robot")
bobmods.lib.tech.add_recipe_unlock("combat-robotics-2", "distractor-robot")
bobmods.lib.tech.add_recipe_unlock("combat-robotics-3", "destroyer-robot")
...
if bobmods.warfare.FlyingRobotFrames == true then
  ...
  bobmods.lib.tech.add_prerequisite("combat-robotics", "robotics")

  if data.raw.item["flying-robot-frame-2"] then
    bobmods.lib.recipe.add_ingredient("distractor-robot", {"flying-robot-frame-2", 1})
    bobmods.lib.tech.add_prerequisite("combat-robotics-2", "bob-robotics-2")
  else
  ...
  if data.raw.item["flying-robot-frame-3"] then
    ...
    bobmods.lib.tech.add_prerequisite("combat-robotics-3", "bob-robotics-3")
  else
  ...
  if data.raw.item["flying-robot-frame-4"] then
    ...
    bobmods.lib.tech.add_prerequisite("combat-robotics-4", "bob-robotics-4")
  else
...
if data.raw.recipe["robot-brain-combat"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics", "robot-brain-combat")
  bobmods.lib.recipe.add_ingredient("defender-robot", {"robot-brain-combat", 1})
else
  bobmods.lib.recipe.add_ingredient("defender-robot", {"electronic-circuit", 1})
end
if data.raw.recipe["robot-brain-combat-2"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics-2", "robot-brain-combat-2")
  bobmods.lib.recipe.add_ingredient("distractor-robot", {"robot-brain-combat-2", 1})
else
  bobmods.lib.recipe.add_ingredient("distractor-robot", {"advanced-circuit", 1})
end
if data.raw.recipe["robot-brain-combat-3"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics-3", "robot-brain-combat-3")
  bobmods.lib.recipe.add_ingredient("destroyer-robot", {"robot-brain-combat-3", 1})
else
  bobmods.lib.recipe.add_ingredient("destroyer-robot", {"processing-unit", 1})
end
if data.raw.recipe["robot-brain-combat-4"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics-4", "robot-brain-combat-4")
...
if data.raw.recipe["robot-tool-combat-3"] then
  ...
  if data.raw.item["emerald-5"] then
    bobmods.lib.recipe.add_ingredient("robot-tool-combat-2", {"emerald-5", 1})
  end
end
...
if data.raw.recipe["robot-tool-combat"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics", "robot-tool-combat")
...
if data.raw.recipe["robot-tool-combat-2"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics-2", "robot-tool-combat-2")
...
if data.raw.recipe["robot-tool-combat-3"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics-3", "robot-tool-combat-3")
...
if data.raw.recipe["robot-tool-combat-4"] then
  bobmods.lib.tech.add_recipe_unlock("combat-robotics-4", "robot-tool-combat-4")
