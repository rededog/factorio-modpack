...
if data.raw.item["alien-artifact"] then
  ...
  bobmods.lib.recipe.add_new_ingredient("exoskeleton-equipment-2", {"alien-artifact", 10})
else
  ...
  bobmods.lib.recipe.add_new_ingredient("exoskeleton-equipment-2", {"processing-unit", 10})
end
