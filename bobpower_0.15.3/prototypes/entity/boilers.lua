...
function bobmods.power.boiler_patch()
return {
      east =
      {
...
function bobmods.power.boiler_fire()
return {
...
function bobmods.power.boiler_fire_glow()
return {
      north =
      {
...
{
  {
    ...
    patch = bobmods.power.boiler_patch(),
    fire_flicker_enabled = true,
    fire = bobmods.power.boiler_fire(),
    fire_glow_flicker_enabled = true,
    fire_glow = bobmods.power.boiler_fire_glow(),
    burning_cooldown = 20
  },
