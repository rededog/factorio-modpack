...
if data.raw.tool["logistic-science-pack"] then
  bobmods.lib.tech.replace_science_pack("electric-pole-4", "production-science-pack", "logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("electric-substation-4", "production-science-pack", "logistic-science-pack")
end