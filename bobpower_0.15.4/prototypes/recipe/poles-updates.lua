...
if data.raw.item["aluminium-plate"] then
  bobmods.lib.recipe.replace_ingredient("substation-2", "steel-plate", "aluminium-plate")
  bobmods.lib.tech.add_prerequisite("electric-substation-2", "aluminium-processing")
else
  if data.raw.item["brass-alloy"] then
