...
if settings.startup["bobmods-vehicleequipment-enablevehiclegrids"].value == true then
  ...
  data.raw["fluid-wagon"]["fluid-wagon"].equipment_grid = "bob-cargo-wagon"
...
if data.raw["fluid-wagon"]["bob-fluid-wagon-2"] then
  data.raw["fluid-wagon"]["bob-fluid-wagon-2"].equipment_grid = "bob-cargo-wagon-2"
end
...
if data.raw["fluid-wagon"]["bob-fluid-wagon-3"] then
  data.raw["fluid-wagon"]["bob-fluid-wagon-3"].equipment_grid = "bob-cargo-wagon-3"
end
...
if data.raw["fluid-wagon"]["bob-armoured-fluid-wagon"] then
  data.raw["fluid-wagon"]["bob-armoured-fluid-wagon"].equipment_grid = "bob-armoured-cargo-wagon"
end
...
if data.raw["fluid-wagon"]["bob-armoured-fluid-wagon-2"] then
  data.raw["fluid-wagon"]["bob-armoured-fluid-wagon-2"].equipment_grid = "bob-armoured-cargo-wagon-2"
end
