...
if data.raw.item["basic-electronic-components"] then
  ...
  bobmods.lib.recipe.replace_ingredient("pollution-clean-processor", "electronic-circuit", "basic-electronic-components")
  bobmods.lib.recipe.replace_ingredient("pollution-create-processor", "electronic-circuit", "basic-electronic-components")
end
...
if data.raw.item["processing-electronics"] then
  ...
  bobmods.lib.recipe.add_difficulty_ingredient("pollution-clean-processor-3", "expensive", {"processing-electronics", 3})

  bobmods.lib.recipe.add_difficulty_ingredient("pollution-create-processor-3", "normal", {"processing-electronics", 1})
  bobmods.lib.recipe.add_difficulty_ingredient("pollution-create-processor-3", "expensive", {"processing-electronics", 3})
  ...
  if data.raw.item["advanced-processing-unit"] then
    ...
    bobmods.lib.recipe.add_difficulty_ingredient("productivity-processor-3", "normal", {"advanced-processing-unit", 1})
    bobmods.lib.recipe.add_difficulty_ingredient("pollution-clean-processor-3", "normal", {"advanced-processing-unit", 1})
    bobmods.lib.recipe.add_difficulty_ingredient("pollution-create-processor-3", "normal", {"advanced-processing-unit", 1})

    bobmods.lib.recipe.add_difficulty_ingredient("speed-processor-3", "expensive", {"advanced-processing-unit", 3})
    bobmods.lib.recipe.add_difficulty_ingredient("effectivity-processor-3", "expensive", {"advanced-processing-unit", 3})
    bobmods.lib.recipe.add_difficulty_ingredient("productivity-processor-3", "expensive", {"advanced-processing-unit", 3})
    bobmods.lib.recipe.add_difficulty_ingredient("pollution-clean-processor-3", "expensive", {"advanced-processing-unit", 3})
    bobmods.lib.recipe.add_difficulty_ingredient("pollution-create-processor-3", "expensive", {"advanced-processing-unit", 3})
  else
