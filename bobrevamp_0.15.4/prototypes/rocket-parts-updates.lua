...
bobmods.lib.tech.add_prerequisite("rocket-silo", "low-density-structure")
bobmods.lib.tech.remove_recipe_unlock("rocket-silo", "low-density-structure")
if data.raw.item["titanium-plate"] then
  bobmods.lib.recipe.replace_ingredient("low-density-structure", "steel-plate", "titanium-plate")
  bobmods.lib.tech.replace_prerequisite("low-density-structure", "steel-processing", "titanium-processing")
end
